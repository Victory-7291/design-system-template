import { AspectRatio } from "@design-system/ui";
...
const meta: Meta<typeof AspectRatio> = {
  ...
  render: (args) => (
    <AspectRatio {...args} className="bg-slate-50 dark:bg-slate-800">
      <img alt="Photo by Alvaro Pinot" src="https://images.unsplash.com/photo-1576075796033-848c2a5f3696?w=800&dpr=2&q=80" className="h-full w-full rounded-md object-cover" />
    </AspectRatio>
  ),
  decorators: [
    (Story) => (
